"""
Django settings for ai_test_demo_44421 project.
...
ROOT_URLCONF = 'ai_test_demo_44421.urls'
...
WSGI_APPLICATION = 'ai_test_demo_44421.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ai_test_demo_44421 API",
    "DESCRIPTION": "API documentation for ai_test_demo_44421 App",
    "VERSION": "v1",
}
